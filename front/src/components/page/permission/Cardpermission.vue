        ...
        <v-card class="mx-auto" max-width="1000">
          <v-card-text class="d-flex">
            <v-card-subtitle class="d-flex">
              ...
              <v-card-text>
                <p class="text-h6">
                  USERNAME: {{ dataPermission.student.firstName }}
                </p>
            ...
            <v-card-subtitle>
              <v-card-text>
                <p class="text-h6">
                  <v-icon class="blue--text">mdi-calendar-clock</v-icon>
                  {{ dataPermission.start_date }}
                </p>
                <p class="text-h6">
                  <v-icon class="red--text">mdi-calendar-clock</v-icon>
                  {{ dataPermission.end_date }}
                </p>
              </v-card-text>
            </v-card-subtitle>
            <v-card-subtitle>
              <v-card-text>
                ...
                <strong
                  v-html="
                    Math.round(
                      (new Date(dataPermission.end_date).getTime() -
                        new Date(dataPermission.start_date).getTime()) /
                        (1000 * 3600 * 24)
                    )
                  "
                >
          ...
          <v-expand-transition>
            ...
            >
              <v-card-text class="pb-0">
                <p class="text-h4 text--primary">Reason</p>
